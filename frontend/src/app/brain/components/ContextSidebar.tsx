...
/**
 * Right sidebar: active project, brain memory, and suggestions.
 */
    ...
    <div className="border-l border-white/[0.06] p-4 overflow-y-auto">
      ...
      <div className="mb-4">
        ...
        <div className="space-y-2">
          {brainMemory ? <MemoryEntries memory={brainMemory} /> : <DefaultMemoryPlaceholders />}
        </div>
      </div>
...
function MemoryEntries({ memory }: { memory: BrainMemory }) {
