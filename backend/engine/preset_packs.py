...
PRESET_PACKS: list[dict[str, Any]] = [
    # ── Core 10 ──────────────────────────────────────────────────────────────
    {
        ...
        "model": "flux-dev",
        "workflow": "flux_dev",
        "defaults": {"steps": 25, "cfg": 1.0, "guidance": 3.5, "width": 1024, "height": 1024, "sampler": "euler"},
    ...
    },
    {
        ...
        "model": "flux-dev",
        "workflow": "flux_dev",
        "defaults": {"steps": 20, "cfg": 1.0, "guidance": 4.0, "width": 1024, "height": 1024, "sampler": "euler"},
    ...
    },
    {
        ...
        "model": "flux-dev",
        "workflow": "flux_dev",
        "defaults": {"steps": 20, "cfg": 1.0, "guidance": 3.5, "width": 1536, "height": 1024, "sampler": "euler"},
    ...
    },
    {
        ...
        "model": "flux-dev",
        "workflow": "flux_dev",
        "defaults": {"steps": 20, "cfg": 1.0, "guidance": 3.5, "width": 1024, "height": 1024, "sampler": "euler"},
    ...
    },
    {
        ...
        "model": "flux-dev",
        "workflow": "flux_dev",
        "defaults": {"steps": 25, "cfg": 1.0, "guidance": 3.5, "width": 1024, "height": 1536, "sampler": "euler"},
    ...
    },
    {
        ...
        "model": "flux-dev",
        "workflow": "flux_dev",
        "defaults": {"steps": 30, "cfg": 1.0, "guidance": 5.0, "width": 1536, "height": 1024, "sampler": "euler"},
