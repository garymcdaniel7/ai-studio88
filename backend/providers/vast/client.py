...
class VastClient:
    ...
    def launch_instance(
        ...
        payload: dict[str, Any] = {
            ...
            "image": img,
            "disk": disk,
            # ssh_proxy auto-exposes proxied ports (ComfyUI 8188, worker API
            # 7860) so the deployed backend can reach the worker without a
            # manual tunnel. Plain "ssh" leaves only SSH exposed.
            "runtype": "ssh_proxy",
        }
        if onstart:
